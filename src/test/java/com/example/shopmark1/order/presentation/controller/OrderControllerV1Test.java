package com.example.shopmark1.order.presentation.controller;
...
import com.example.shopmark1.order.presentation.dto.request.ReqPostOrdersDtoV1;
import com.example.shopmark1.order.presentation.dto.response.ResPostOrdersDtoV1;
...
class OrderControllerV1Test {
    ...
    void testPostOrdersSuccess() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(
                ...
                .andExpectAll(
                        ...
                        MockMvcResultMatchers.jsonPath("$.data.order.status").value(OrderEntity.Status.CREATED.toString())
                )
                .andDo(
    ...
    void testPostOrdersCancelSuccess() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpectAll(
                        MockMvcResultMatchers.status().isOk(),
                        MockMvcResultMatchers.jsonPath("$.data.order.status").value(OrderEntity.Status.CANCELLED.toString())
                );
    }
