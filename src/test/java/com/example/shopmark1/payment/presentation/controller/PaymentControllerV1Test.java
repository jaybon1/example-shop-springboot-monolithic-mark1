package com.example.shopmark1.payment.presentation.controller;
...
import com.example.shopmark1.payment.domain.entity.PaymentEntity.Method;
import com.example.shopmark1.payment.domain.entity.PaymentEntity.Status;
import com.example.shopmark1.payment.presentation.dto.request.ReqPostPaymentsDtoV1;
import com.example.shopmark1.payment.presentation.dto.response.ResGetPaymentsWithIdDtoV1;
    ...
    void testPostPaymentsSuccess() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(
                ...
                .andExpectAll(
                        ...
                        MockMvcResultMatchers.jsonPath("$.data.payment.orderStatus").value(OrderEntity.Status.PAID.toString())
                )
                .andDo(
