package com.example.shopmark1.global.util;
...
//                throw new RuntimeException(arg + "와 관련된 정보가 없습니다.");
    ...
    public static String generateAccessJwtBy(UserEntity userEntity) {
        ...
        return JWT.create()
                ...
                .withClaim("roleList", userEntity.getUserRoleList()
                        .stream()
    ...
    public static String generateRefreshJwtBy(UserEntity userEntity) {
